...
<br><br>
## 關於專案
此專案是自主開發，目的在於深化自身實作網頁前端設計能力。網站具響應式網頁設計(RWD)。專案採 **Next.js 全端框架** 與 **Firebase 無伺服器資料庫 (Serverless DB)** 開發，嚴格遵守前後端分離，將前後端以 RESTful API 串接，並且以 Adapter Pattern 設計後端與資料庫溝通，以便更好維護兩者。
<br><br>
