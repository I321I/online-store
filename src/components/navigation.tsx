  ...
  return (
    <nav className="flex h-24 w-screen flex-row flex-wrap justify-between border-b-2 border-solid p-3 pr-10 pl-8 max-sm:h-20">
      <div className="flex flex-row flex-wrap gap-10">
        ...
        <Link
          href="/product"
          className="font-sans-serif content-center text-3xl decoration-2 underline-offset-3 hover:underline active:not-aria-[haspopup]:translate-y-px max-md:hidden"
        >
          {t("products")}
        </Link>
      </div>
